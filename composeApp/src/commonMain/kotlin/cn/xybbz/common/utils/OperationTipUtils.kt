...
object OperationTipUtils {
    ...
    suspend fun operationTipNotToBlock(
         loadingMessage: StringResource = Res.string.deleting,
         successMessage: StringResource = Res.string.delete_success,
         errorMessage: StringResource = Res.string.delete_failed,
    ...
    suspend fun operationTipNotToBlockAndThrow(
         loadingMessage: StringResource = Res.string.deleting,
         successMessage: StringResource = Res.string.delete_success,
         failMessage: StringResource = Res.string.delete_success,
         errorMessage: StringResource = Res.string.delete_failed,
        operation: suspend () -> Boolean
    ): Boolean {
        MessageUtils.sendPopTip(loadingMessage)
