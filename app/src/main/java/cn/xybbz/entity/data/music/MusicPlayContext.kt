 ...
 * 音乐播放请求上下文
 */
class MusicPlayContext @OptIn(UnstableApi::class)
@Inject constructor(
    ...
    fun music(
        ...
        val musicPlayContext = MusicPlayData(
            ...
            xyMusicList = {
                val pageNum =
                    MusicListIndexUtils.getPageNum(index, Constants.ALBUM_MUSIC_LIST_PAGE_SIZE)
                ...
                val musicList = dataSourceManager.getMusicList(
                    pageNum = pageNum,
                    pageSize = Constants.ALBUM_MUSIC_LIST_PAGE_SIZE
                ) ?: listOf()
            ...
            xyMusicList = {
                ...
                val musicList = if (onMusicPlayParameter.albumId != null) {
                    ...
                    val pageNum = MusicListIndexUtils.getPageNum(
                        progress?.index ?: 0,
                        Constants.ALBUM_MUSIC_LIST_PAGE_SIZE
                    )
