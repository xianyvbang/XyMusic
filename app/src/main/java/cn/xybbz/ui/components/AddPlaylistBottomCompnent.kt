...
val playlistObject by mutableStateOf<AddPlaylistBottomData>(
        ...
        LazyColumnNotComponent(
            ...
            item {
                XyRow {
                    XyText(text = "加入歌单")
                    IconButton(onClick = {
                        var playlistName by mutableStateOf("新建歌单${playlistBottomViewModel.playlists.size}")
                        AlertDialogObject(
                            title = {
                        ...
                        Icon(imageVector = Icons.Rounded.Add, contentDescription = "创建歌单")
                    }
                }
            ...
            itemsIndexed(
                ...
                MusicPlaylistItemComponent(
                    ...
                    name = item.name,
                    subordination = "${item.musicCount}首歌",
                    imgUrl = item.pic,
//                    brush = null,
